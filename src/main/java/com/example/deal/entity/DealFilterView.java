 ...
 * </ul>
 * 
 * <p><b>KEY CONCEPT:</b> This entity produces ONE ROW PER PROGRAM.
...
public record DealFilterView(
     ...
     * 
     * <p>Produces one row per (deal, program) combination.
     * LEFT JOINs ensure deals without analysts or programs are included.</p>
     */
